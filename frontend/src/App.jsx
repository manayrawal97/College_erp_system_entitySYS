...
const PlaceholderPage = ({ title }) => (
  <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-navy">
    <h1 className="text-4xl font-bold text-primary dark:text-white">{title} Page Coming Soon</h1>
  </div>
);

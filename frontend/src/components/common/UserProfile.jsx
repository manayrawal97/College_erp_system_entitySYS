                ...
                >
                    ...
                    <div className="w-full space-y-3">
                        ...
                        <button 
                            ...
                            className="w-full flex items-center justify-center gap-3 bg-gray-50 text-gray-600 py-4 rounded-2xl font-black text-sm hover:bg-gray-100 transition-all border border-gray-100 active:scale-95"
                        >

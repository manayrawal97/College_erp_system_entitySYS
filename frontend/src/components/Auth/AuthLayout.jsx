...
const AuthLayout = ({ children, title, subtitle, illustration }) => {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#f8fafc] dark:bg-navy overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative">
        {/* Background mesh for dark mode */}
        <div className="absolute inset-0 bg-mesh opacity-50 dark:opacity-0 pointer-events-none" />

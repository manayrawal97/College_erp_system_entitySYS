  ...
  return (
    ...
    >
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`block w-full pl-10 pr-3 py-3 border rounded-xl focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200 bg-white/50 dark:bg-navy/50 dark:text-white ${
        ...
        <Link 
          to="/login" 
          className="flex items-center justify-center gap-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-secondary transition-colors"
        >

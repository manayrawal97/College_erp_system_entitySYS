...
const Navbar = () => {
 ...
 key={link.name}
 to={link.path}
 className={`font-semibold text-sm uppercase tracking-wider transition-all hover:text-secondary relative group ${
 ...
 <button
 className={`flex items-center space-x-2 font-semibold text-sm uppercase tracking-wider transition-all group ${
 isScrolled ? 'text-primary' : 'text-white'

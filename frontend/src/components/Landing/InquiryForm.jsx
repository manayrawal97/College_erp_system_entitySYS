    ...
    <section className="section-padding bg-white relative overflow-hidden" id="inquiry">
      <div className="container mx-auto px-6 relative z-10">
        <div className="bg-primary rounded-[4rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row">
          ...
          {/* Content Side */}
          <div className="lg:w-2/5 p-12 md:p-20 text-white flex flex-col">
            <motion.div
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="w-20 h-20 bg-gradient-to-br from-secondary to-accent rounded-3xl flex items-center justify-center text-4xl mb-12 shadow-2xl"
            >
              <HiOutlineChatAlt2 />
            </motion.div>
            ...
            <div className="space-y-8 mt-auto">
              {[
                ...
                <div key={i} className="flex items-center space-x-6 group cursor-pointer">
                  <div className="w-14 h-14 glass-dark rounded-2xl flex items-center justify-center text-2xl group-hover:bg-secondary group-hover:text-white transition-all">
                    <item.icon />
                  </div>
                  <div>
          ...
          {/* Form Side */}
          <div className="lg:w-3/5 p-8 md:p-20 bg-slate-50">
              ...
              <AnimatePresence>
                {isSuccess && (
                  <motion.div 
                    ...
                    exit={{ opacity: 0 }}
                    className="absolute inset-0 bg-white/80 z-30 flex flex-col items-center justify-center text-center p-10 rounded-3xl"
                  >
                    <div className="w-24 h-24 bg-emerald-500 rounded-full flex items-center justify-center text-white text-5xl mb-6 shadow-2xl animate-bounce">
                      <HiCheck />
                    </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative group">
                      ...
                      <input 
                        ...
                        className={`w-full pl-14 pr-6 py-5 rounded-2xl border-2 ${errors.fullName ? 'border-red-500 bg-red-50' : 'border-white bg-white shadow-sm'} focus:border-secondary transition-all outline-none font-bold text-primary placeholder:text-gray-300`}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative group">
                      ...
                      <input 
                        ...
                        className={`w-full pl-14 pr-6 py-5 rounded-2xl border-2 ${errors.email ? 'border-red-500 bg-red-50' : 'border-white bg-white shadow-sm'} focus:border-secondary transition-all outline-none font-bold text-primary placeholder:text-gray-300`}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative group">
                      ...
                      <select 
                        ...
                        onChange={handleChange}
                        className={`w-full pl-14 pr-6 py-5 rounded-2xl border-2 ${errors.course ? 'border-red-500 bg-red-50' : 'border-white bg-white shadow-sm'} focus:border-secondary transition-all outline-none font-bold text-primary appearance-none cursor-pointer`}
                      >
                  ...
                  <div className="space-y-3">
                    ...
                    <input 
                      ...
                      onChange={handleChange}
                      placeholder="Answer"
                      className={`w-full px-6 py-5 rounded-2xl border-2 ${errors.captcha ? 'border-red-500 bg-red-50' : 'border-white bg-white shadow-sm'} focus:border-secondary transition-all outline-none font-bold text-primary`}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <textarea 
                    ...
                    className={`w-full px-8 py-6 rounded-3xl border-2 ${errors.message ? 'border-red-500 bg-red-50' : 'border-white bg-white shadow-sm'} focus:border-secondary transition-all outline-none font-bold text-primary resize-none placeholder:text-gray-300`}
                  ></textarea>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-4">
                  ...
                  <button 
                    ...
                    className="w-full md:w-auto px-12 py-6 bg-primary text-white rounded-[2rem] font-black uppercase tracking-[0.2em] shadow-2xl hover:bg-secondary hover:shadow-secondary/30 transition-all transform active:scale-95 flex items-center justify-center space-x-4"
                  >

...
const KPICard = ({ title, value, icon: Icon, color, trend, trendUp, index }) => {
  return (
    <motion.div 
      ...
      className="bg-white dark:bg-navy-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-navy-700 flex items-center gap-4 group hover:shadow-md transition-shadow cursor-pointer"
    >
